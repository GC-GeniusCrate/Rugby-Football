...
namespace GeniusCrate.Utility
{
    ...
    public class NotificationManager : MonoBehaviour
    {
        ...
        [SerializeField] private string dailyNotificationTitle = "Hey ";
        [SerializeField] private string dailyNotificationText = "Come back..";
        ...
        private void OnApplicationPause(bool pause)
        {
            if (pause)
            {
                ...
                androidDailyNotification.Title = dailyNotificationTitle +" "+ PlayfabManager.Instance._displayName;
